...
(function (global, factory) {
  ...
  var Lexer_1 = /*#__PURE__*/function () {
    ...
    _proto.updateLineNumberForPreviousToken = function updateLineNumberForPreviousToken(tokens, lineNumber) {
      var lastToken;
    ...
    _proto.updateLineNumberForCurrentToken = function updateLineNumberForCurrentToken(token, lineNumber) {
    ...
    _proto.parse = function parse(tokens, top) {
      ...
      for (i = 0; i < l; i++) {
        ...
        switch (token.type) {
          ...
          case 'heading':
            {
              out += this.renderer.heading(this.parseInline(token.tokens), token.depth, unescape$1(this.parseInline(token.tokens, this.textRenderer)), this.slugger, token.dataLine);
              continue;
            }
